#Country codes that can be used on i94res and i94 cit
i94_country_codes = {
...
#combination of given sas_labels and manual editing to the values to find full name of state
i94_state_codes = {
    'AL': 'Alabama',
    'AK': 'Alaska',
    'AZ': 'Arizona',
